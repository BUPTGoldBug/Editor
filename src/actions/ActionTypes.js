...
export const AR_GAME_SELECT_INIT = "AR_GAME_SELECT_INIT";
...
export const AR_GAME_CATCH_CHANGE_PROCESSER = "AR_GAME_CATCH_CHANGE_PROCESSER" ;//kaiguan
export const AR_GAME_CATCH_CHANGE_PROCESSER_INDEX = "AR_GAME_CATCH_CHANGE_PROCESSER_INDEX" ;//修改进度
export const AR_GAME_CATCH_CHANGE_INTO_GAME = "AR_GAME_CATCH_CHANGE_INTO_GAME";
export const AR_GAME_CATCH_CHANGE_OUT_GAME = "AR_GAME_CATCH_CHANGE_OUT_GAME";